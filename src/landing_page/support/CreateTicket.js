    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                <h1 className='fs-4 mx-1' style={{fontWeight:"400"}}>To create a ticket, select a relevant topic</h1>
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 mb-3' style={{fontWeight:"400"}}><i class="fa fa-plus-circle" aria-hidden="true" style={{marginLeft:"-30px"}}></i>&nbsp; Account Opening</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 mb-3'style={{fontWeight:"400"}}><i class="fa fa-user" aria-hidden="true" style={{marginLeft:"-30px"}}></i>&nbsp; Your Zerodha Account</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className='fs-5 mb-3' style={{fontWeight:"400"}}><i class="fa fa-bar-chart" aria-hidden="true" style={{marginLeft:"-30px"}}></i>&nbsp; Trading and Markets</h4>
                    ...
                    <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Nudge</a> <br/>
                    ...
                    <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Margin reporting and margin penalty+</a> <br/>
                </div>
                <div className='col-4 p-5 mt-1 mb-2'>
                    <h4 className='fs-5 mb-3' style={{fontWeight:"400"}}><i class="fa fa-credit-card" aria-hidden="true" style={{marginLeft:"-30px"}}></i>&nbsp; Funds</h4>
                ...
                <div className='col-4 p-5 mt-1 mb-2'>
                    <h4 className='fs-5 mb-3' style={{fontWeight:"400"}}><i class="fa fa-pie-chart" aria-hidden="true" style={{marginLeft:"-30px"}}></i>&nbsp; Console</h4>
                ...
                <div className='col-4 p-5 mt-1 mb-2'>
                    <h4 className='fs-5 mb-3' style={{fontWeight:"400"}}><i class="fa fa-circle-o-notch" aria-hidden="true" style={{marginLeft:"-30px"}}></i>&nbsp; Coin</h4>
